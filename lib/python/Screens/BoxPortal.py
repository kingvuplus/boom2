...
class BoxPortal(Screen):
    ...
    def __init__(self, session):
        ...
        self['shortcuts'] = ActionMap(['ShortcutActions', 'WizardActions'], {'ok': self.okbuttonClick,
         'back': self.exit,
         'cancel': self.exit,
         'red': self.exit,
         'green': self.exit,
        ...
        if config.servicelist.lastmode.value == 'tv':
            list.append((_('Switch to Radio'),
             'radio',
             '',
             '50'))
        elif config.servicelist.lastmode.value == 'radio':
            list.append((_('Switch to TV'),
             'tv',
             '',
             '50'))
        list.append((_('Show Record Movies'),
         'pvr',
         '',
         '50'))
        list.append((_('Media Center'),
         'bmc',
         '',
         '50'))
        self['menu'] = List(list)
