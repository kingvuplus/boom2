...
class ScanSetup(ConfigListScreen, Screen, CableTransponderSearchSupport, TerrestrialTransponderSearchSupport):
    ...
    def createConfig(self, frontendData):
        ...
        self.scan_ter.system = ConfigSelection(default=defaultTer['system'], choices=[(eDVBFrontendParametersTerrestrial.System_DVB_T, _('DVB-T')), (eDVBFrontendParametersTerrestrial.System_DVB_T2, _('DVB-T2'))])
