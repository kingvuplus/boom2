# Embedded file name: /usr/lib/enigma2/python/ItalySat/ItalysatCronManager.py
...
class ItalyCronManager(Screen):
    ...
    def addtocron(self):
        self.session.openWithCallback(self.updateList, ItalySetupCronConf)
