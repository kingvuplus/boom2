# Embedded file name: /usr/lib/enigma2/python/ItalySat/ItalysatUsbFormat.py
...
class UsbFormat(Screen):
    ...
    def __init__(self, session):
        ...
        msg += _('Please be sure that your usb drive is NOT CONNECTED to your box before you continue.\n')
    ...
    def stepOne(self):
        msg = _('Connect your usb storage to your box\n')
    ...
    def succesS(self):
        mybox = self.session.openWithCallback(self.hreBoot, MessageBox, _("The Box will be now restarted to generate a new device UUID.\nDon't forget to remap your device after the reboot.\nPress ok to continue"), MessageBox.TYPE_INFO)
