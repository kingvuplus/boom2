...
LanguageCodes['gwi'] = ('Gwich\xef\xbe\xb4in', '')
...
LanguageCodes['nob'] = LanguageCodes['nb'] = ('Norwegian Bokm\xef\xbf\xa5l', '')
...
LanguageCodes['oci'] = LanguageCodes['oc'] = ('Occitan (post 1500); Proven\xef\xbf\xa7al', 'Romance')
...
LanguageCodes['pro'] = ('Proven\xef\xbf\xa7al, Old (to 1500)', '')
...
LanguageCodes['vol'] = LanguageCodes['vo'] = ('Volap\xef\xbf\xbck', 'International aux.')
